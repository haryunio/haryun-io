...
Hereby는 계약의 준비와 검토, 체결, 체결 후 관리까지 하나의 흐름으로 연결하는 AI 기반 계약 관리 플랫폼이었다. 나는 백엔드와 AI 개발을 맡는 동시에 요구사항을 제품으로 구체화하고 출시하는 과정에 참여했다. OCR과 LLM을 붙이는 것보다, 불완전할 수 있는 AI의 결과를 사용자가 확인하고 실제 계약 업무에 안전하게 활용하도록 만드는 일이 더 큰 과제였다. 나의 프로젝트 참여는 회사를 나온 2026년 3월에 마무리되었다.
