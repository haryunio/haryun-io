...
**Law Student, Software Engineer (Blockchain, Data, AI/LLM Agents)**  
Daegu, South Korea  
...
- AI-based contract management service development(Python, LLM/agent-based workflows)
- AI infrastructure (vLLM, local models)
...
- Firmachain ecosystem and business strategy, Baseline rebranding
